// Minimal line-icon set for the toolbar chrome — replaces emoji glyphs with
// consistent 1.8px stroke icons so the UI reads as one deliberate system
// instead of mixed platform emoji renderings.
...
export function IconEraser(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M18.4 13.4 10 21H5l-2-2 9.6-9.6a2 2 0 0 1 2.8 0l3 3a2 2 0 0 1 0 2z" />
...
export function IconCursor(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M5 3l6.5 17 2-7 7-2L5 3z" />
    </Icon>
  )
}
